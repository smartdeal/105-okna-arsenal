...
<body id="top">
        ...
        <div class="container">
            ...
            <div class="b-sert-wrap">
                <div class="b-sert owl-carousel">
                    <div class="item">
                        <a href="images/sertificat.jpg" class="fancybox" rel="group1"></a><img src="images/sertificat.jpg" alt=""></div>
                    <div class="item">
                        <a href="images/sertificat.jpg" class="fancybox" rel="group1"></a><img src="images/sertificat.jpg" alt=""></div>
                    <div class="item">
                        <a href="images/sertificat.jpg" class="fancybox" rel="group1"></a><img src="images/sertificat.jpg" alt=""></div>
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="b-adv-wrap">
                        <ul class="b-adv-list owl-carousel">
                            ...
                            <li class="item i_2"><span>Заключение договора на дому <a href="#">(скачать договор)</a></span></li>
        ...
        <div class="container">
            ...
            <div class="b-how-many-list-wrap">
                <div class="b-how-many-list owl-carousel">
                    ...
                    <div class="itm">
                        <a href="images/b-how-many-07.jpg" class="fancybox" rel="group2"><img src="images/b-how-many-08.jpg"></a>
                        <div class="description"></div>
                    </div>
                    <div class="itm">
                        <a href="images/b-how-many-07.jpg" class="fancybox" rel="group2"><img src="images/b-how-many-09.jpg"></a>
                        <div class="description"></div>
                    </div>
                    <div class="itm">
                        <a href="images/b-how-many-07.jpg" class="fancybox" rel="group2"><img src="images/b-how-many-10.jpg"></a>
                        <div class="description"></div>
                    </div>
                </div>
            </div>
    ...
    <div class="s-map section">
        <div class="b-map">
            <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=UR4RqQlyBsmZzphugEfjt_Zsq8DsEubz&width=100%&height=670&lang=ru_RU&sourceType=constructor&scroll=false"></script>
        </div>
    ...
    <div class="s-footer-info-pl section hidden-xs">
        <div class="b_info">
            <div class="container">
                ...
                <div class="b_rekv visible-lg-inline-block">
                    <p>БИК 048702640</p>
                    <p>ОГРН 316110100051883</p>
                    <p>ИНН 110119361356</p>
                </div>
        ...
        <div class="popup-wrap">
            <form class="form-popup">
                <div class="f-title">Оставьте свои контакты,
                    <br>чтобы получить консультацию специалиста</div>
                <div class="f-body">
            ...
            <div class="popup-success-dog">
                <p>Скачать</p>
                <p><a href="/dogovor-okonniy-dvorik.docx">образец&nbsp;договора.</a></p>
                <button class="btn ok-btn">ОК</button>
            </div>
